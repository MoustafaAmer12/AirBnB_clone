...
def split_curly_braces(e_arg):
    """
    Curly braces are splitted  for the update method
    """
...
class HBNBCommand(cmd.Cmd):
    """
    The Console class for HBNBCommand
    """
    prompt = "(hbnb) "
    ...
    def emptyline(self):
        """
        No action when an empty line is entered.
        """
        pass

    def do_EOF(self, arg):
        """
        signal to exit the program EOF (ctrl+D)
        """
        return True

    def do_quit(self, arg):
        """
        Quit command exits from the program.
        """
        return True
    ...
    def do_show(self, arg):
        ...
        It's usage is to: show <class_name> <id>
        """
        commands = shlex.split(arg)
    ...
    def do_destroy(self, arg):
        ...
        It's usage is to: destroy <class_name> <id>
        """
        commands = shlex.split(arg)
    ...
    def do_count(self, arg):
        """
        Performs count and retrieving of the number of instances of a class
        It's usage is: <class name>.count()
        """
        objects = storage.all()
    ...
    def do_update(self, arg):
        """
        Updates an instances by adding or updating the attributes
        It's usage is to: update <class_name> <id> <attribute_name> "<attribute_value>"
        """
        commands = shlex.split(arg)
